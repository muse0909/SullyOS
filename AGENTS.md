...
| 2026-08-01 | 一起听 / mini player 3 个 bug 修（折叠态拖动 / play_song_and_join prompt / listen-together 通知 type 分类） | [`changelogs/2026-08-01-music-3-bugs-round4.md`](./changelogs/2026-08-01-music-3-bugs-round4.md) |
...
| 2026-08-03 | 见面 app：思维链嵌进消息气泡内部（去掉 emoji + 琥珀色） + 强制中文 thinking prompt 增强 | [`changelogs/2026-08-03-dateapp-thinking-bubble-inside-and-zh-prompt.md`](./changelogs/2026-08-03-dateapp-thinking-bubble-inside-and-zh-prompt.md) |
| 2026-08-03 | 见面 app：失败时重发最后一条 user 消息（v2 修复 — 不重复入库） | [`changelogs/2026-08-03-dateapp-resend-last-user-msg.md`](./changelogs/2026-08-03-dateapp-resend-last-user-msg.md) |
| 2026-08-04 | 见面 app：聊天快捷键（全局共用 + 第一个固定全屏输入） + 4 按钮布局修复 | [`changelogs/2026-08-04-dateapp-quick-phrases-and-4button-fix.md`](./changelogs/2026-08-04-dateapp-quick-phrases-and-4button-fix.md) |
...
| 2026-08-04 | 见面 app 3 模式 prompt 拆分 — 去掉 novel/longform 的 `[emotion]` 标签（文学/口语两套新 prompt） | [`changelogs/2026-08-04-dateapp-3mode-prompt-split.md`](./changelogs/2026-08-04-dateapp-3mode-prompt-split.md) |
| 2026-08-05 | 三连修复：Gemini 池重试 2→3 + 角色 API 清空 + 一键向量化计数（filter 不一致 + totalProcessed 累计 + force 阈值 10→5） | [`changelogs/2026-08-05-three-fixes-gemini-clear-vectorize.md`](./changelogs/2026-08-05-three-fixes-gemini-clear-vectorize.md) |
| 2026-08-05 | 记忆宫殿一键向量化重构（callLLM 超时 / JSON 兜底 / 统一入口 / 5 轮 / 删立即追平 / 清空弹窗升级） | [`changelogs/2026-08-05-memory-palace-force-vectorize-refactor.md`](./changelogs/2026-08-05-memory-palace-force-vectorize-refactor.md) |
| 2026-08-06 | 主动消息 2.0 Cloudflare Worker 部署 + 端到端联调（worker 脚手架 / 仪表盘 4 字段 / 10021 错误 / 4 secret / D1 binding / Vercel env） | [`changelogs/2026-08-06-amsg2-cloudflare-worker-scaffold.md`](./changelogs/2026-08-06-amsg2-cloudflare-worker-scaffold.md) |
| 2026-08-06 | 主动消息「首次开启 schedule 没起」+ prompt 重写（startProactiveChat 闭包老 ref bug + 暮色新版 prompt） | [`changelogs/2026-08-06-proactive-start-bug-and-prompt-rewrite.md`](./changelogs/2026-08-06-proactive-start-bug-and-prompt-rewrite.md) |
| 2026-08-06 | 思维链 2 修（正常聊天也加 + 主动消息 prompt 加回 7-27 段 + 解析 metadata.thought + MessageItem 取消 proactiveRoundStart 限制 + 角色独立 API 走主 API bug 按 protocol 选 baseUrl 修） | [`changelogs/2026-08-06-thought-chain-all-modes-and-usecharapi-fix.md`](./changelogs/2026-08-06-thought-chain-all-modes-and-usecharapi-fix.md) |
