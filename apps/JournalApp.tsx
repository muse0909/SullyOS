            ...
            <div className="h-full w-full bg-white flex flex-col font-light relative">
                ...
                {viewingCharOnly && (
                    <div className="absolute inset-0 z-50 bg-[#1a1a1a] flex flex-col animate-fade-in">
                        <div className="pt-10 pb-2 px-4 flex items-center justify-between text-white shrink-0 z-10">
                            <button
                        ...
                        <div className="flex-1 overflow-y-auto px-4 pb-4 no-scrollbar">
                            <div className="bg-[#fffdf5] rounded-3xl shadow-md p-5 min-h-full" style={{ backgroundImage: 'radial-gradient(#d1d5db 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
