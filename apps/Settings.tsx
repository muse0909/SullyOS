  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-b from-slate-50/80 to-white/90 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-8 space-y-0">
        <SettingsSection id="backup" icon="💾" title="备份与恢复" subtitle="导出/导入数据·格式化系统">
          {/* 数据备份区域 */}
          ...
          {/* 云端备份区域 */}
          <section className="bg-white/80 rounded-3xl p-5 shadow-sm border border-white/50 mt-4">
            <div className="flex items-center gap-2 mb-4">
        ...
        <SettingsSection id="imageGen" icon="🖼️" title="生图服务" subtitle="NAI / OpenAI·分离风格"
