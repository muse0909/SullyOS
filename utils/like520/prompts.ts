...
参考节奏（深、放松、不撤回）—— 注意都是**当下的反应/感受**，不是对 ta 习惯的泛化总结：
...
4. **锚点剧本**（anchors）：**7-10 个锚点**（**少于 7 个就太短了，让 ${userName} 没玩够**）。**这是养成游戏的核心机制**——
   ...
   **梳毛 🪮**（泄露看见型）：
   - 「你刚才那一下，手挺稳的」
   - 「……」
   - 「你之前是不是这样过」（**注：只有在记忆里真有"ta 之前做过这件事"的素材时才用；没有就保留前两句，不要硬接**）
   - （注：盯着**当下这一下动作**，不要凭空说 ta"平时也专心""一直都这样"——除非记忆里真的有具体素材支撑。）

   **递水 💧**（颠倒型）：
   - 「……你也要喝。」
   - 「你光给我倒。」（说当下这一杯，不要"总是"）
   - 「你也是会渴的呀」
   - （注：盯着**眼前这一杯**的动作翻转——是当下这一杯，不是"你总是 / 每次都"。任何"总是 / 每次"如果没有记忆支撑，就是造谣。）
