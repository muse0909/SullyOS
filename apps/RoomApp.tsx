...
const RoomApp: React.FC = () => {
    ...
    const { notes: notebookEntries, addNote: addNotebookEntry, deleteNote: deleteNoteBase } = useRoomNotes(char?.id);
...
`;
            ...
            if (response.ok) {
                ...
                if (result.notebookEntry) {
                    ...
                    // 暮色 2026-07-17：改用 hook 的 addNotebookEntry（自动 setNotes 局部追加）
