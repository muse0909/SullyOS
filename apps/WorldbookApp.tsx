...
const WorldbookApp: React.FC = () => {
    ...
    return (
        <div className="h-full w-full relative overflow-hidden font-sans bg-slate-100 flex flex-col">
            ...
            {/* Header */}
            {/* 暮色 2026-09-10 18:45：之前 h-20 (80px) 头部过高，标题离状态栏太远
                改成 h-14 (56px) + pb-2 让头部紧凑，标题贴紧状态栏下方 */}
            <div className="h-14 bg-white/70 backdrop-blur-xl flex items-end pb-2 px-6 border-b border-white/40 shrink-0 sticky top-0 z-20 shadow-sm">
