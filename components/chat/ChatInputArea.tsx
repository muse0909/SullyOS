                    ...
                    {showPanel === 'actions' && (
                        <div className="overflow-y-auto no-scrollbar p-6">
                          <div className="grid grid-cols-4 gap-6">
                            ...
                            <button onClick={() => onPanelAction('active-msg-2')} className={`flex flex-col items-center gap-2 active:scale-95 transition-transform ${isDiscordStyle ? 'text-slate-200' : 'text-slate-600'}`}>
